...
if (GPU_TYPE STREQUAL h100)
  if (OPENACC_GPU_OFFLOAD)
   string(APPEND OPENACC_GPU_FLAGS  " -acc -gpu=ccnative,lineinfo,nofma -Minfo=accel ")
  endif()
  if (OPENMP_GPU_OFFLOAD)
   string(APPEND OPENMP_GPU_FLAGS  " -mp=gpu -gpu=ccnative,lineinfo,nofma -Minfo=accel ")
  endif()
endif()
